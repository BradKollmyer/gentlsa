...
complete -c gentlsa -n "__fish_gentlsa_using_subcommand help; and not __fish_seen_subcommand_from generate list prune rollover verify cloudflare nsupdate route53 google completions file help" -f -a "generate" -d 'Generate a TLSA record from a live certificate'
complete -c gentlsa -n "__fish_gentlsa_using_subcommand help; and not __fish_seen_subcommand_from generate list prune rollover verify cloudflare nsupdate route53 google completions file help" -f -a "list" -d 'List published TLSA records from DNS (and optionally a publisher)'
complete -c gentlsa -n "__fish_gentlsa_using_subcommand help; and not __fish_seen_subcommand_from generate list prune rollover verify cloudflare nsupdate route53 google completions file help" -f -a "prune" -d 'Remove stale TLSA records that no longer match the live certificate'
complete -c gentlsa -n "__fish_gentlsa_using_subcommand help; and not __fish_seen_subcommand_from generate list prune rollover verify cloudflare nsupdate route53 google completions file help" -f -a "rollover" -d 'Publish a new-cert hash, wait 2× the TLSA TTL, reload, wait, then prune'
complete -c gentlsa -n "__fish_gentlsa_using_subcommand help; and not __fish_seen_subcommand_from generate list prune rollover verify cloudflare nsupdate route53 google completions file help" -f -a "verify" -d 'Verify DNS TLSA against the live certificate (Nagios-compatible)'
complete -c gentlsa -n "__fish_gentlsa_using_subcommand help; and not __fish_seen_subcommand_from generate list prune rollover verify cloudflare nsupdate route53 google completions file help" -f -a "cloudflare" -d 'Cloudflare helpers'
complete -c gentlsa -n "__fish_gentlsa_using_subcommand help; and not __fish_seen_subcommand_from generate list prune rollover verify cloudflare nsupdate route53 google completions file help" -f -a "nsupdate" -d 'RFC 2136 / TSIG helpers'
complete -c gentlsa -n "__fish_gentlsa_using_subcommand help; and not __fish_seen_subcommand_from generate list prune rollover verify cloudflare nsupdate route53 google completions file help" -f -a "route53" -d 'Amazon Route 53 helpers'
complete -c gentlsa -n "__fish_gentlsa_using_subcommand help; and not __fish_seen_subcommand_from generate list prune rollover verify cloudflare nsupdate route53 google completions file help" -f -a "google" -d 'Google Cloud DNS helpers'
complete -c gentlsa -n "__fish_gentlsa_using_subcommand help; and not __fish_seen_subcommand_from generate list prune rollover verify cloudflare nsupdate route53 google completions file help" -f -a "completions" -d 'Show TLSA info for a local certificate file Print a shell completion script to stdout'
complete -c gentlsa -n "__fish_gentlsa_using_subcommand help; and not __fish_seen_subcommand_from generate list prune rollover verify cloudflare nsupdate route53 google completions file help" -f -a "file" -d 'Mutually exclusive publisher flags shared by generate/list/prune/file/rollover'
complete -c gentlsa -n "__fish_gentlsa_using_subcommand help; and not __fish_seen_subcommand_from generate list prune rollover verify cloudflare nsupdate route53 google completions file help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
